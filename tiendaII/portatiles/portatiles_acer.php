             			...
             			<section class="fila">
   			            <section class="noticiasportatiles"> 
            				<article>
               					...
               					<img src="portatiles_acer/portatiles_acer.jpg" />

								<h2>Precio 749€ 
								</h2>

								<section class="caja">
									<p>Las mejores características en un práctico tamaño. Portátiles delgados y ligeros, de 1 											1.6”a 14’ sucesores de los netbooks, con potentes características al alcance de la mano. 											Ideales para viajar y para la movilidad diaria, con numerosas herramientas de 											conectividad</p>
									<span class="info">
										<?php
										try {
