...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					<p section class="nombreseccion"> Portátiles </p>
     				<section class="productos">
             			<section class="fila">
   			            <section class="noticiasportatiles"> 
            				<article>
               					<h1>Portátil hp 630</h1> 

               					<img src="portatiles_hp_630/portatiles_hp_630.jpg" />

								<h2>Precio 499€ 
								</h2>

								<section class="caja">
									<p>Diseño elegante: Este portátil tiene un diseño ID sofisticado con una superficie mate suave en color estaño sutil, obteniendo un aspecto limpio y profesional. 
PROCESADOR INTEL P6200, PANTALLA 15,6LED, 4GB MEMORIA RAM Y 320 GB DISCO DURO. Windows® 7 Home Premium 64 original. HDMI MODELO HP 630 P/NLH368EA#ABE Tipo de procesador Procesador Intel® Pentium® P6200 (2,13 GHz, 3 MB L3 de caché ) Sistema operativo instalado
Windows® 7 Home Premium 64 original Chipset Mobile Intel® HM55 Express Dimensiones y peso Peso del producto A partir de 2,5 kg</p>
									<span class="info">
									<?php
										try {
