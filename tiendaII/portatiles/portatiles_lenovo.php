             			...
             			<section class="fila">
   			            <section class="noticiasportatiles"> 
            				<article>
               					...
               					<img src="portatiles_lenovo/portatiles_lenovo.jpg" />

								<h2>Precio 649€ 
								</h2>

								<section class="caja">
									<p>Con este modelo G50-70 obtendrás un impresionant procesador Intel Core i7, RAM de 8GB y gráfica AMD Radeon R5 dedicada de 2GB. Y por este motivo, nos encontramos delante un portátil que es ideal para Gaming, para trabajar con videos o con programas de modelación en 3D.</p>
									<span class="info">
									<?php
										try {
